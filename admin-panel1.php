...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> City Hospital</a>
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right,#4E4FEB, #4E4FEB);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #4E4FEB, #4E4FEB); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #4E4FEB, #4E4FEB);
    background: linear-gradient(to right, #4E4FEB, #4E4FEB);
    border-color: #c3c3c3;
}
.text-primary {
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list"  role="tab" data-toggle="list" aria-controls="home">Inquiries</a>
