...
<html lang="en">
  ...
  <body style="background:#4E4FEB;background: -webkit-linear-gradient(to bottom, #4E4FEB, #4E4FEB);background: linear-gradient(to bottom, #4E4FEB, #4E4FEB); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp City Hospital </h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <!-- <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right:25%">
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-info"></center></div>           
